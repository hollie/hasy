...
export LoadConfigTBL_onewire_gateway_Bank1
export LoadConfigTBL_onewire_gateway_Bank0
export LoadConfigTBL_onewire_gateway_Ordered
AREA lit(rom, rel)
LoadConfigTBL_onewire_gateway_Ordered:
;  Ordered Global Register values
	...
	ret
LoadConfigTBL_onewire_gateway_Bank0:
...
;       Instance name Ticker, Block Name CNTR16_MSB(DCB23)
	...
	db		ffh
LoadConfigTBL_onewire_gateway_Bank1:
;  Global Register values
