...
export LoadConfig_onewire_gateway
export _LoadConfig_onewire_gateway
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_onewire_gateway_Ordered
	lcall	LoadConfig_onewire_gateway
...
;---------------------------------------------------------------------------
; Load Configuration onewire_gateway
;
;    Load configuration registers for onewire_gateway.
...
;               CUR_PP
;
_LoadConfig_onewire_gateway:
 LoadConfig_onewire_gateway:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_onewire_gateway_Bank0
    mov     X, <LoadConfigTBL_onewire_gateway_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_onewire_gateway_Bank1
    mov     X, <LoadConfigTBL_onewire_gateway_Bank1
