...
;  the underscore.
;-------------------------------------------------------------------
export  UART_IN_SetTxIntMode
export _UART_IN_SetTxIntMode
export  UART_IN_EnableInt
export _UART_IN_EnableInt
export  UART_IN_DisableInt
export _UART_IN_DisableInt

export  UART_IN_Start
export _UART_IN_Start
export  UART_IN_Stop
export _UART_IN_Stop
export  UART_IN_SendData
export _UART_IN_SendData
export  UART_IN_bReadTxStatus
export _UART_IN_bReadTxStatus
export  UART_IN_bReadRxData
export _UART_IN_bReadRxData
export  UART_IN_bReadRxStatus
export _UART_IN_bReadRxStatus

export  UART_IN_IntCntl
export _UART_IN_IntCntl

export  UART_IN_TxIntMode
export _UART_IN_TxIntMode

export  UART_IN_PutSHexByte
export _UART_IN_PutSHexByte
export  UART_IN_PutSHexInt
export _UART_IN_PutSHexInt

export  UART_IN_CPutString
export _UART_IN_CPutString
export  UART_IN_PutString
export _UART_IN_PutString
export  UART_IN_PutChar
export _UART_IN_PutChar
export  UART_IN_Write
export _UART_IN_Write
export  UART_IN_CWrite
export _UART_IN_CWrite

export  UART_IN_cGetChar
export _UART_IN_cGetChar
export  UART_IN_cReadChar
export _UART_IN_cReadChar
export  UART_IN_iReadChar
export _UART_IN_iReadChar
export  UART_IN_PutCRLF
export _UART_IN_PutCRLF

IF (UART_IN_RXBUF_ENABLE)
export  UART_IN_CmdReset
export _UART_IN_CmdReset
export  UART_IN_bCmdCheck
export _UART_IN_bCmdCheck
export  UART_IN_bCmdLength
export _UART_IN_bCmdLength
export  UART_IN_bErrCheck
export _UART_IN_bErrCheck

export  UART_IN_szGetParam
export _UART_IN_szGetParam
export  UART_IN_szGetRestOfParams
export _UART_IN_szGetRestOfParams
ENDIF
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
export  bUART_IN_ReadTxStatus
export _bUART_IN_ReadTxStatus
export  bUART_IN_ReadRxData
export _bUART_IN_ReadRxData
export  bUART_IN_ReadRxStatus
export _bUART_IN_ReadRxStatus
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_EnableInt
;
;  DESCRIPTION:
...
_UART_IN_EnableInt:
   ...
   M8C_EnableIntMask UART_IN_TX_INT_REG, UART_IN_TX_INT_MASK
   M8C_EnableIntMask UART_IN_RX_INT_REG, UART_IN_RX_INT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_DisableInt
;
;  DESCRIPTION:
...
_UART_IN_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask UART_IN_TX_INT_REG, UART_IN_TX_INT_MASK
   M8C_DisableIntMask UART_IN_RX_INT_REG, UART_IN_RX_INT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
;
 UART_IN_SetTxIntMode:
_UART_IN_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, UART_IN_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[UART_IN_TX_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[UART_IN_TX_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_UART_IN_Start:
   ...
   mov   REG[UART_IN_TX_CONTROL_REG], A
   mov   REG[UART_IN_RX_CONTROL_REG], A
IF ( UART_IN_RXBUF_ENABLE )
   call  _UART_IN_CmdReset
ENDIF
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_UART_IN_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[UART_IN_TX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   and   REG[UART_IN_RX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_SendData
;
;  DESCRIPTION:
...
_UART_IN_SendData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov REG[UART_IN_TX_BUFFER_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_bReadTxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 UART_IN_bReadTxStatus:
_UART_IN_bReadTxStatus:
 bUART_IN_ReadTxStatus:                          ; For backwards compatibility only
_bUART_IN_ReadTxStatus:                          ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[UART_IN_TX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_bReadRxData
;
;  DESCRIPTION:
...
;
 UART_IN_bReadRxData:
_UART_IN_bReadRxData:
 bUART_IN_ReadRxData:                            ; For backwards compatibility only
_bUART_IN_ReadRxData:                            ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[UART_IN_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 UART_IN_bReadRxStatus:
_UART_IN_bReadRxStatus:
 bUART_IN_ReadRxStatus:                          ; For backwards compatibility only
_bUART_IN_ReadRxStatus:                          ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[UART_IN_RX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_TxIntMode
;
;  DESCRIPTION:
...
_UART_IN_TxIntMode:
   ...
   and  A,UART_IN_INT_MODE_TX_COMPLETE
   M8C_SetBank1
   cmp  A,UART_IN_INT_MODE_TX_COMPLETE
   jz   .SetTxCmpMode

   and  reg[UART_IN_TX_FUNC_REG],0xEF            ; Set Interrupt on Tx_Reg_Empty
   jmp  .TxIntMode_End

.SetTxCmpMode:                                       ; Set Interrupt on TX Complete
   or   reg[UART_IN_TX_FUNC_REG],0x10
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_PutSHexByte
;
;  DESCRIPTION:
...
_UART_IN_PutSHexByte:
   ...
   index UART_IN_HEX_STR               ; Get Hex value
   call  UART_IN_PutChar               ; Write data to screen
   pop   A                             ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_PutSHexInt
;
;  DESCRIPTION:
...
_UART_IN_PutSHexInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   swap  A,X
   call  UART_IN_PutSHexByte           ; Print MSB
   mov   A,X                           ; Move LSB into position
   call  UART_IN_PutSHexByte           ; Print LSB
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.BufEmptyWaitLoop:
   tst REG[UART_IN_TX_CONTROL_REG], UART_IN_TX_BUFFER_EMPTY     ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[UART_IN_TX_BUFFER_REG], @Source       ; Write data to Tx Port
   endm
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_cGetChar
;
;  DESCRIPTION:
...
_UART_IN_cGetChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   tst REG[UART_IN_RX_CONTROL_REG],UART_IN_RX_REG_FULL    ; Check if a character is ready
   jz  UART_IN_cGetChar                              ; If not loop
   mov A, REG[UART_IN_RX_BUFFER_REG]                 ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;-----------------------------------------------------------------------------
...
_UART_IN_cReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,REG[UART_IN_RX_CONTROL_REG]                      ; Get Status of RX
   push A
   and  A,UART_IN_RX_COMPLETE                              ; Check if a character is ready
...
.RX_DATA_RDY:
   ...
   and  A,(UART_IN_RX_PARITY_ERROR | UART_IN_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_iReadChar
;
...
_UART_IN_iReadChar:
   ...
   and  A,(UART_IN_RX_ERROR|UART_IN_RX_REG_FULL)
   push A
   and  A,UART_IN_RX_COMPLETE                              ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,UART_IN_RX_NO_DATA                               ; Add no data flag
   swap A,X
   jmp  End_UART_IN_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,UART_IN_RX_ERROR
   swap A,X
   mov  A,REG[UART_IN_RX_BUFFER_REG ]                      ; Read data first, then
                                                           ; determine if data is valid

 End_UART_IN_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_PutString
;
;  DESCRIPTION:
...
.PutStringLoop:
   ...
   call  UART_IN_PutChar                         ; Send character to Tx port
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;-----------------------------------------------------------------------------
...
_UART_IN_CPutString:
   ...
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  UART_IN_PutChar                         ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   UART_IN_CPutString                      ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   UART_IN_CPutString
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_CmdReset
;
;  DESCRIPTION:
...
_UART_IN_CmdReset:
   ...
   RAM_SETPAGE_CUR >UART_IN_aRxBuffer
   mov [UART_IN_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >UART_IN_bRxCnt
   mov [UART_IN_bRxCnt], 0x00
   and [UART_IN_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_bCmdCheck
;
;  DESCRIPTION:
...
_UART_IN_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >UART_IN_fStatus
   mov A,  [UART_IN_fStatus]
   and A, UART_IN_RX_BUF_CMDTERM                 ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_bErrCheck
;
;  DESCRIPTION:
...
_UART_IN_bErrCheck:
   ...
   RAM_SETPAGE_CUR >UART_IN_fStatus
   mov A,  [UART_IN_fStatus]
   and A, UART_IN_RX_BUF_ERROR                   ; Mask off Error status
   and [UART_IN_fStatus], ~UART_IN_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_bCmdLength
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_szGetParam
;
;  DESCRIPTION:
;      Return next parameter from UART_IN Rx buffer
;-----------------------------------------------------------------------------
;
;  ARGUMENTS:  none
;
...
;     UART_IN_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, UART_IN_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See UART_IN_bCmdCheck).
;
...
_UART_IN_szGetParam:
   ...
   RAM_SETPAGE_CUR >ptrParam
   mov   A, <UART_IN_aRxBuffer              ; Get address to receive buffer
   add   A, [ptrParam]                      ; Add string offset
   mov   X, A
   RAM_SETPAGE_IDX >UART_IN_aRxBuffer
...
.ParamLoop:                                 ; Now loop until end of parameter found.
   ...
   inc   [ptrParam]
   cmp   [ptrParam], (UART_IN_RX_BUFFER_SIZE -1)   ; Check if we are at the end of buffer
   jz    .TerminateString
   mov   A, [X]                             ; Get next character
   jz    .End_GetNextParam
   cmp   A, UART_IN_DELIMITER               ; Check if we have a delimiter
   ...
   mov   [ptrParam], (UART_IN_RX_BUFFER_SIZE -1)   ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A, >UART_IN_aRxBuffer               ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_IN_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 UART_IN_szGetRestOfParams:
_UART_IN_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
   mov  A, <UART_IN_aRxBuffer               ; Get address to receive buffer
   add  A, [ptrParam]                       ; Add string offset
