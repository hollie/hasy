...
;  Instance name Speed_PWM, User Module PWM8
;       Instance name Speed_PWM, Block Name PWM8(DBB00)
	db		23h, 00h		;Speed_PWM_CONTROL_REG(DBB00CR0)
	db		21h, 64h		;Speed_PWM_PERIOD_REG(DBB00DR1)
	db		22h, 00h		;Speed_PWM_COMPARE_REG(DBB00DR2)
...
;  Instance name Speed_PWM, User Module PWM8
;       Instance name Speed_PWM, Block Name PWM8(DBB00)
	db		20h, 79h		;Speed_PWM_FUNC_REG(DBB00FN)
	db		21h, 15h		;Speed_PWM_INPUT_REG(DBB00IN)
	db		22h, 47h		;Speed_PWM_OUTPUT_REG(DBB00OU)
;  Instance name Ticker, User Module Counter16
;       Instance name Ticker, Block Name CNTR16_LSB(DCB22)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[08h], e2h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], 1fh		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], 77h		; Port_2_DriveMode_2 register (PRT2DM2)
	mov	reg[0ah], a8h		; Port_2_GlobalSelect register (PRT2GS)
	M8C_SetBank1
