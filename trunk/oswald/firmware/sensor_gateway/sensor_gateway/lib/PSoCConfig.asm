...
export LoadConfig_sensor_gateway
export _LoadConfig_sensor_gateway
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_sensor_gateway_Ordered
	lcall	LoadConfig_sensor_gateway
...
;---------------------------------------------------------------------------
; Load Configuration sensor_gateway
;
;    Load configuration registers for sensor_gateway.
...
;               CUR_PP
;
_LoadConfig_sensor_gateway:
 LoadConfig_sensor_gateway:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_sensor_gateway_Bank0
    mov     X, <LoadConfigTBL_sensor_gateway_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_sensor_gateway_Bank1
    mov     X, <LoadConfigTBL_sensor_gateway_Bank1
