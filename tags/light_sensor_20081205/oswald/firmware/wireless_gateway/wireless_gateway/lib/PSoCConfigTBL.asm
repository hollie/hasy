...
export LoadConfigTBL_wireless_gateway_Bank1
export LoadConfigTBL_wireless_gateway_Bank0
export LoadConfigTBL_wireless_gateway_Ordered
AREA lit(rom, rel)
LoadConfigTBL_wireless_gateway_Ordered:
;  Ordered Global Register values
	...
	ret
LoadConfigTBL_wireless_gateway_Bank0:
...
;       Instance name UART_IN, Block Name RX(DCB03)
	db		2fh, 00h		;UART_IN_RX_CONTROL_REG(DCB03CR0)
	db		2dh, 00h		;UART_IN_(DCB03DR1)
	db		2eh, 00h		;UART_IN_RX_BUFFER_REG (DCB03DR2)
;       Instance name UART_IN, Block Name TX(DCB02)
	db		2bh, 00h		;UART_IN_TX_CONTROL_REG(DCB02CR0)
	db		29h, 00h		;UART_IN_TX_BUFFER_REG (DCB02DR1)
	db		2ah, 00h		;UART_IN_(DCB02DR2)
	db		ffh
LoadConfigTBL_wireless_gateway_Bank1:
;  Global Register values
...
;  Instance name UART_IN, User Module UART
;       Instance name UART_IN, Block Name RX(DCB03)
	db		2ch, 05h		;UART_IN_RX_FUNC_REG   (DCB03FN)
	db		2dh, c2h		;UART_IN_RX_INPUT_REG  (DCB03IN)
	db		2eh, 40h		;UART_IN_RX_OUTPUT_REG (DCB03OU)
;       Instance name UART_IN, Block Name TX(DCB02)
	db		28h, 1dh		;UART_IN_TX_FUNC_REG   (DCB02FN)
	db		29h, 02h		;UART_IN_TX_INPUT_REG  (DCB02IN)
	db		2ah, 40h		;UART_IN_TX_OUTPUT_REG (DCB02OU)
	db		ffh
