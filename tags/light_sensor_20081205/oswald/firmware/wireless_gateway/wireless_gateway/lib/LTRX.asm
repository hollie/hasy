...
;  the underscore.
;-------------------------------------------------------------------
export  LTRX_SetTxIntMode
export _LTRX_SetTxIntMode
export  LTRX_EnableInt
export _LTRX_EnableInt
export  LTRX_DisableInt
export _LTRX_DisableInt

export  LTRX_Start
export _LTRX_Start
export  LTRX_Stop
export _LTRX_Stop
export  LTRX_SendData
export _LTRX_SendData
export  LTRX_bReadTxStatus
export _LTRX_bReadTxStatus
export  LTRX_bReadRxData
export _LTRX_bReadRxData
export  LTRX_bReadRxStatus
export _LTRX_bReadRxStatus

export  LTRX_IntCntl
export _LTRX_IntCntl

export  LTRX_TxIntMode
export _LTRX_TxIntMode

export  LTRX_PutSHexByte
export _LTRX_PutSHexByte
export  LTRX_PutSHexInt
export _LTRX_PutSHexInt

export  LTRX_CPutString
export _LTRX_CPutString
export  LTRX_PutString
export _LTRX_PutString
export  LTRX_PutChar
export _LTRX_PutChar
export  LTRX_Write
export _LTRX_Write
export  LTRX_CWrite
export _LTRX_CWrite

export  LTRX_cGetChar
export _LTRX_cGetChar
export  LTRX_cReadChar
export _LTRX_cReadChar
export  LTRX_iReadChar
export _LTRX_iReadChar
export  LTRX_PutCRLF
export _LTRX_PutCRLF

IF (LTRX_RXBUF_ENABLE)
export  LTRX_CmdReset
export _LTRX_CmdReset
export  LTRX_bCmdCheck
export _LTRX_bCmdCheck
export  LTRX_bCmdLength
export _LTRX_bCmdLength
export  LTRX_bErrCheck
export _LTRX_bErrCheck

export  LTRX_szGetParam
export _LTRX_szGetParam
export  LTRX_szGetRestOfParams
export _LTRX_szGetRestOfParams
ENDIF
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
export  bLTRX_ReadTxStatus
export _bLTRX_ReadTxStatus
export  bLTRX_ReadRxData
export _bLTRX_ReadRxData
export  bLTRX_ReadRxStatus
export _bLTRX_ReadRxStatus
...
_LTRX_EnableInt:
   ...
   M8C_EnableIntMask LTRX_TX_INT_REG, LTRX_TX_INT_MASK
   M8C_EnableIntMask LTRX_RX_INT_REG, LTRX_RX_INT_MASK
...
_LTRX_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask LTRX_TX_INT_REG, LTRX_TX_INT_MASK
   M8C_DisableIntMask LTRX_RX_INT_REG, LTRX_RX_INT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
_LTRX_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, LTRX_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[LTRX_TX_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[LTRX_TX_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_LTRX_Start:
   ...
   mov   REG[LTRX_TX_CONTROL_REG], A
   mov   REG[LTRX_RX_CONTROL_REG], A
IF ( LTRX_RXBUF_ENABLE )
   call  _LTRX_CmdReset
ENDIF
   RAM_EPILOGUE RAM_USE_CLASS_1
...
_LTRX_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[LTRX_TX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   and   REG[LTRX_RX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_bReadTxStatus
;
;  DESCRIPTION:
...
;
 LTRX_bReadTxStatus:
_LTRX_bReadTxStatus:
 bLTRX_ReadTxStatus:                             ; For backwards compatibility only
_bLTRX_ReadTxStatus:                             ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[LTRX_TX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_bReadRxData
;
;  DESCRIPTION:
...
;
 LTRX_bReadRxData:
_LTRX_bReadRxData:
 bLTRX_ReadRxData:                               ; For backwards compatibility only
_bLTRX_ReadRxData:                               ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[LTRX_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_bReadRxStatus
;
;  DESCRIPTION:
...
;
 LTRX_bReadRxStatus:
_LTRX_bReadRxStatus:
 bLTRX_ReadRxStatus:                             ; For backwards compatibility only
_bLTRX_ReadRxStatus:                             ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[LTRX_RX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_LTRX_TxIntMode:
   ...
   and  A,LTRX_INT_MODE_TX_COMPLETE
   M8C_SetBank1
   cmp  A,LTRX_INT_MODE_TX_COMPLETE
   jz   .SetTxCmpMode

   and  reg[LTRX_TX_FUNC_REG],0xEF               ; Set Interrupt on Tx_Reg_Empty
   jmp  .TxIntMode_End

.SetTxCmpMode:                                       ; Set Interrupt on TX Complete
   or   reg[LTRX_TX_FUNC_REG],0x10
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_PutSHexByte
;
;  DESCRIPTION:
...
_LTRX_PutSHexByte:
   ...
   index LTRX_HEX_STR                  ; Get Hex value
   call  LTRX_PutChar                  ; Write data to screen
   pop   A                             ; Restore value
...
_LTRX_PutSHexInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   swap  A,X
   call  LTRX_PutSHexByte              ; Print MSB
   mov   A,X                           ; Move LSB into position
   call  LTRX_PutSHexByte              ; Print LSB
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.BufEmptyWaitLoop:
   tst REG[LTRX_TX_CONTROL_REG], LTRX_TX_BUFFER_EMPTY     ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[LTRX_TX_BUFFER_REG], @Source          ; Write data to Tx Port
   endm
...
_LTRX_cGetChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   tst REG[LTRX_RX_CONTROL_REG],LTRX_RX_REG_FULL    ; Check if a character is ready
   jz  LTRX_cGetChar                             ; If not loop
   mov A, REG[LTRX_RX_BUFFER_REG]                ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_LTRX_cReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,REG[LTRX_RX_CONTROL_REG]                         ; Get Status of RX
   push A
   and  A,LTRX_RX_COMPLETE                                 ; Check if a character is ready
...
.RX_DATA_RDY:
   ...
   and  A,(LTRX_RX_PARITY_ERROR | LTRX_RX_FRAMING_ERROR)
...
_LTRX_iReadChar:
   ...
   and  A,(LTRX_RX_ERROR|LTRX_RX_REG_FULL)
   push A
   and  A,LTRX_RX_COMPLETE                                 ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,LTRX_RX_NO_DATA                                  ; Add no data flag
   swap A,X
   jmp  End_LTRX_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,LTRX_RX_ERROR
   swap A,X
   mov  A,REG[LTRX_RX_BUFFER_REG ]                         ; Read data first, then
...
.PutStringLoop:
   ...
   call  LTRX_PutChar                            ; Send character to Tx port
...
_LTRX_CPutString:
   ...
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  LTRX_PutChar                            ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   LTRX_CPutString                         ; Check for carry
...
_LTRX_CmdReset:
   ...
   RAM_SETPAGE_CUR >LTRX_aRxBuffer
   mov [LTRX_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >LTRX_bRxCnt
   mov [LTRX_bRxCnt], 0x00
   and [LTRX_fStatus], 0x00
...
_LTRX_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >LTRX_fStatus
   mov A,  [LTRX_fStatus]
   and A, LTRX_RX_BUF_CMDTERM                    ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
_LTRX_bErrCheck:
   ...
   RAM_SETPAGE_CUR >LTRX_fStatus
   mov A,  [LTRX_fStatus]
   and A, LTRX_RX_BUF_ERROR                      ; Mask off Error status
   and [LTRX_fStatus], ~LTRX_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_szGetParam
;
;  DESCRIPTION:
;      Return next parameter from LTRX Rx buffer
;-----------------------------------------------------------------------------
;
;  ARGUMENTS:  none
;
...
;     LTRX_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, LTRX_szGetParam, is
...
_LTRX_szGetParam:
   ...
   RAM_SETPAGE_CUR >ptrParam
   mov   A, <LTRX_aRxBuffer                 ; Get address to receive buffer
...
.ParamLoop:                                 ; Now loop until end of parameter found.
   ...
   inc   [ptrParam]
   cmp   [ptrParam], (LTRX_RX_BUFFER_SIZE -1)   ; Check if we are at the end of buffer
   jz    .TerminateString
   mov   A, [X]                             ; Get next character
   jz    .End_GetNextParam
   cmp   A, LTRX_DELIMITER                  ; Check if we have a delimiter
   ...
   mov   [ptrParam], (LTRX_RX_BUFFER_SIZE -1)   ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A, >LTRX_aRxBuffer                  ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LTRX_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 LTRX_szGetRestOfParams:
_LTRX_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
   mov  A, <LTRX_aRxBuffer                  ; Get address to receive buffer
   add  A, [ptrParam]                       ; Add string offset
