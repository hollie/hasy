...
* that write operations by design are performed by eight bytes 
* at once. This is handled by loading 4 short values using the
* flash_load_data function.
*
...
#else
	fsr0h  = (char)((address >> 8) & 0x00FF);
	fsr0l  = (char)(address & 0x00FF);
#endif
}
