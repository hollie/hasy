...
my $aww_uit = "$db_folder/aww_uit_new.rrd";
my $int_in  = "$db_folder/unit_int_in_new.rrd";
my $int_uit = "$db_folder/unit_int_uit_new.rrd";
...
RRDs::graph "humi_year.png",
    ...
    "DEF:rv=$humi:rhumi:AVERAGE",
    "DEF:dewpt=$humi:dewpt:AVERAGE",
#    "DEF:dewpt_min=$humi:dewpt:MIN",
#    "DEF:dewpt_max=$humi:dewpt:MAX",
    "LINE:rv#0000FF:Relatieve vochtigheid (%)",
    "LINE:dewpt#00FF00:Dauwpunt (graden C)",
#    "LINE:dewpt#FF0000:test",
    ;
...
RRDs::graph "ventilatie_week.png",
    ...
    "--interlaced",
    "--watermark","http://bouw.lika.be",
    "DEF:aww_uit=$aww_uit:temp:AVERAGE",
    "DEF:aww_uit_min=$aww_uit:temp:MIN",
    "DEF:aww_uit_max=$aww_uit:temp:MAX",
    "DEF:int_in=$int_in:temp:AVERAGE",
    "DEF:int_uit=$int_uit:temp:AVERAGE",
